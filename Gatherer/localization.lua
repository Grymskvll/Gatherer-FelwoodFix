...
--	TREASURE_FISHNODE_TRIGGER2	= "Bloated"; -- no longer found in wreckage in 1.11
	...
	function Gatherer_FindTreasureType(in_input)
		...
		if (string.find(input, TREASURE_NIGHTDRAGON) ) then
			return TREASURE_NIGHTDRAGON, TREASURE_NIGHTDRAGON;
		end
		
		if (string.find(input, TREASURE_WHIPPERROOT) ) then
			return TREASURE_WHIPPERROOT, TREASURE_WHIPPERROOT;
		end
